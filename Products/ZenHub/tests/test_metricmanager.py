...
class MetricManagerTest(TestCase):
    ...
    def test_metric_writer(t, MetricWriter, RedisListPublisher, os):
    ...
    def test__setup_cc_metric_writer(
        t, os, HttpPostPublisher, FilteredMetricWriter, AggregateMetricWriter
    ):
        ...
        FilteredMetricWriter.assert_called_with(
            HttpPostPublisher.return_value, t.mm._internal_metric_filter
        )
